                    ...
                    <div id="following">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="panel panel-default panel-custom">
                                ...
                                <div>
                                    <a title="Desain 360" href="" class="twPc-avatarLink profile__img">
                                        <img alt="Mert Salih Kaplan" src="{{asset('/img/profile_images/'.$following->user->profile_img_url)}}" class="twPc-avatarImg profile__img">
                                    </a>
                
                                    <div class="twPc-divUser">
                                        <div class="twPc-divName">
                                            <a href="#">{{$following->user->name}} </a>
                                        </div>
                                        <span>
                                            <a href="#">@<span>{{$following->user->username}} </span></a>
                                        </span>
                                    </div>
                
                                    <div class="twPc-divStats">
                                        <p>{{$following->user->description}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="media col-md-offset-1">
                            <div class="media-body ">
                                ...
                                <p>Follow people and start tweeting to share your thoughts with them.</p>
                                <a href="">
                                    <button type="" class="btn btn-primary col-sm-5 darkblue__btn ">
